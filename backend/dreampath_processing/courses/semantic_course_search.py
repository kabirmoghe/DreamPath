...
from backend.dreampath_processing.courses.course_relationship_handling_legacy import get_department_alias_from_dept_name, get_department_from_course_code
