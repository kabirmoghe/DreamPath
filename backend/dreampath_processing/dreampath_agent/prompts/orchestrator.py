...
5. **curate**: Review all search results. Produce curated lists of courses (15-25) and activities (3-6), optimizing for coverage across interests, post-grad, and career goals. Consider how clubs complement course gaps.
  - **Important curation guidelines:** take time to actually reflect on the relevance and benefit of items, going beyond simply picking items due to naive keyword matching, which is weak since topics and terms are often be overloaded across contexts. Thoughtfully curate by determining which courses, clubs, activites, etc. will truly help the student explore their interests and move towards their goals. 
