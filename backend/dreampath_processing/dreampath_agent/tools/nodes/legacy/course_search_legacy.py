"""
LEGACY: Course search node using single-shot LLM query generation.

This module is deprecated in favor of course_search.py which uses the
search agent subgraph for iterative search refinement.
