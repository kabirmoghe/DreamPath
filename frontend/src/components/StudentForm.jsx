...
function StudentForm({ majors, onSubmit, initialData = null }) {
  ...
  useEffect(() => {
    if (initialData) {
      ...
      // Start on the summary page (step 5) when initialData is provided
      setCurrentStep(5);
    }
  }, [initialData]);
      ...
      case 5:
        return (
          <>
            ...
            <p className="text-center text-muted small">Review your information above and click "Update DreamPath" to regenerate recommendations.</p>
          </>
        );
      default:
        return null;
